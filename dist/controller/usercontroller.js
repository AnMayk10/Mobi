...
var controller = {
  signUp(req, res) {
    return __async(this, null, function* () {
      if (req === null || req === void 0) {
        throw new Error("resquest invalid or undefined");
      }
      const { user } = req.body;
      const userCreated = yield service.signUp(user);
  ...
  signIn(req, res) {
    return __async(this, null, function* () {
      ...
      const token = yield service.singIn(login);
      if (!token) {
  ...
  getUserSystem(req, res) {
    return __async(this, null, function* () {
      const { id } = req.params;
      const userFound = yield service.getUser(id);
      if (userFound === null) {
